        ...
        [
            ...
            (
                ...
                [
                    new ProjectView(["*"]),
                    new ProjectView(["*"]),
                    new ProjectView(["*"], "img", "col-6", ".png", `./Application_main/Sprites/Pages/Projects/Aplicativos/a_Thumbnails/Navbar/Thumbnail4`, `./Application_main/Sprites/Pages/Projects/Aplicativos/a_Thumbnails/Search/Thumbnail4`, "0", "", "k_PortfolioPage_ProjectsMundoBitaTitle", "k_PortfolioPage_ProjectsMundoBitaDescription", "modal-lg"),
                    new ProjectView(["*"], "img", "col-6", ".png", `./Application_main/Sprites/Pages/Projects/Aplicativos/a_Thumbnails/Navbar/Thumbnail3`, `./Application_main/Sprites/Pages/Projects/Aplicativos/a_Thumbnails/Search/Thumbnail3`,  "0", "", "k_PortfolioPage_ProjectsGalinhaPintadinhaTitle", "k_PortfolioPage_ProjectsGalinhaPintadinhaDescription", "modal-lg"),
                    new ProjectView(["*"], "img", "col-3", ".png", `./Application_main/Sprites/Pages/Projects/Aplicativos/a_Thumbnails/Navbar/Thumbnail2`, `./Application_main/Sprites/Pages/Projects/Aplicativos/a_Thumbnails/Search/Thumbnail2`,  "0", "", "k_PortfolioPage_ProjectsTDMTitle", "k_PortfolioPage_ProjectsTDMDescription", "modal-lg"),
                    new ProjectView(["*"], "img", "col-3", ".png", `./Application_main/Sprites/Pages/Projects/Aplicativos/a_Thumbnails/Navbar/Thumbnail1`, `./Application_main/Sprites/Pages/Projects/Aplicativos/a_Thumbnails/Search/Thumbnail1`,  "0", "", "k_PortfolioPage_ProjectsRoxteenRoxstarTitle", "k_PortfolioPage_ProjectsRoxteenRoxstarDescription", "modal-lg"),
                ],
            ),
            new CategoryView
            (
            ...
            (
                ...
                [Constants.ptBrContent["k_PortfolioPage_Projects3DModels"], Constants.enUsContent["k_PortfolioPage_Projects3DModels"], "render", "modelagem", "3d", "blender", "maya", "substance", "substance painter", "autodesk", "autodesk maya", "renderização", "rendering"],
                CategoryMode.OK,
                ProjectType.Category,
                [
                    new ProjectView(["*"]),
                    ...
                    new ProjectView(["*"], "img", "col-6", ".png", `./Application_main/Sprites/Pages/Projects/Modelagens/a_Thumbnails/Navbar/Thumbnail4`, `./Application_main/Sprites/Pages/Projects/searchPreviewPlaceholder`,  "15", "./Application_main/Sprites/Pages/Projects/Modelagens/Tie Fighter/TieFighter", "k_PortfolioPage_ProjectsTieFighterTitle", "k_PortfolioPage_ProjectsTieFighterDescription", "modal-xl"),
